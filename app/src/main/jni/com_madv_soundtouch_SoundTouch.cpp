...
/**JNIEXPORT*/
extern "C" DLL_PUBLIC jstring Java_com_madv_soundtouch_SoundTouch_getVersionString(JNIEnv *env, jobject thiz)
{
    const char *verStr;
...
extern "C" DLL_PUBLIC jstring Java_com_madv_soundtouch_SoundTouch_getErrorString(JNIEnv *env, jobject thiz)
{
...
extern "C" DLL_PUBLIC jlong Java_com_madv_soundtouch_SoundTouch_newInstance(JNIEnv *env, jobject thiz)
{
	//return (jlong)(new SoundTouch());
	jlong handle = (jlong)(new SoundTouch());
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setSetting(SETTING_SEQUENCE_MS, 40);
    ptr->setSetting(SETTING_SEEKWINDOW_MS, 16);
    ptr->setSetting(SETTING_OVERLAP_MS, 8);
    return handle;
}


extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz, jlong handle)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	delete ptr;
}
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setRate(JNIEnv *env, jobject thiz, jlong handle, jfloat rate)
{
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setRate(rate);
}
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setTempo(tempo);
}
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setRateChange(JNIEnv *env, jobject thiz, jlong handle, jfloat rate)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setTempoChange(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setPitch(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setPitch(pitch);
}
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setPitchOctaves(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
	SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC jint Java_com_madv_soundtouch_SoundTouch_processFile(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
	SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setSampleRate(JNIEnv *env, jobject thiz, jlong handle, jint srate)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_setChannels(JNIEnv *env, jobject thiz, jlong handle, jint numChannels)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_madv_soundtouch_SoundTouch_putSamples
        (JNIEnv *env, jobject thiz, jlong handle, jbyteArray sampleBuffer, jint numSamples)
{
    SoundTouch *ptr = (SoundTouch *) handle;
    jboolean isArrayCopied = false;
    jbyte *samplesArray = env->GetByteArrayElements(sampleBuffer, &isArrayCopied);

    int len = numSamples / 2;
    ptr->putSamples((SAMPLETYPE *) samplesArray, len);

    if (isArrayCopied) {
        env->ReleaseByteArrayElements(sampleBuffer, samplesArray, 0);
    }
}


extern "C" DLL_PUBLIC jint Java_com_madv_soundtouch_SoundTouch_receiveSamples
        (JNIEnv *env, jobject thiz, jlong handle, jbyteArray sampleBuffer, jint maxSamples)
{
    SoundTouch *ptr = (SoundTouch *) handle;
    jboolean isArrayCopied = false;
    jbyte *samplesArray = env->GetByteArrayElements(sampleBuffer, &isArrayCopied);

    int len = maxSamples / 2;
    int num = ptr->receiveSamples((SAMPLETYPE *) samplesArray, len);
...
extern "C" DLL_PUBLIC jint Java_com_madv_soundtouch_SoundTouch_flush
